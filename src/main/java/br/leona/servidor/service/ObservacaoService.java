...
public class ObservacaoService implements Serializable{
    ...
    public int movimentar(int p, String l) {
        ...
        if (l == "azimute"){
            ...
            //Coloca o método do WS de mover azimute

            r = 1;
            System.out.println("Movimentou Azimute");
        }
        if (l == "elevacao"){
            
            //Coloca o método do WS de mover elevação
            r = 1;
            System.out.println("Movimentou Elevação");
        }
        if (l == "OFF"){
            r = 1;
        ...
        if (l == "RESET"){
            r = 1;
            //Coloca o método do WS de resetar
