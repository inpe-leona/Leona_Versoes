...
public class RedirecionarPaginasController {
    ...
    //region Usuario
    public static final String GESTAO_USUARIO = webinf+"usuario/usuario.jsp";
    ...
    public static final String GESTAO_OBSERVACAO = webinf+"observacao/observacao.jsp";
    public static final String CADASTRO_OBSERVACAO_OK = webinf+"observacao/okobservacao.jsp";    
//endregion    
    
    //region Imagem
    public static final String GESTAO_IMAGEM = webinf+"imagem/imagem.jsp";
    public static final String PASTAIMAGEM = webinf+"imagem/pastaImagem.jsp";
    public static final String IMAGENSOBS = webinf+"imagem/imagensObservacao.jsp";
    //endregion
